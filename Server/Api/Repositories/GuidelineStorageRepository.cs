...
/// <summary>
/// Implements <see cref="IGuidelineStorageRepository"/> for storing guideline files in MinIO object storage.
/// </summary>
public class GuidelineStorageRepository : IGuidelineStorageRepository
{
	private readonly IMinioClient _minioClient;

	/// <summary>
	/// Initializes a new instance of the <see cref="GuidelineStorageRepository"/> class.
	/// </summary>
	/// <param name="minioClient">The MinIO client for interacting with the object storage.</param>
	public GuidelineStorageRepository(IMinioClient minioClient)
	{
