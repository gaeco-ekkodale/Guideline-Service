...
public class PostgresOptions
{
	...
	/// <summary>
	/// Gets or sets the database server host. Defaults to 'localhost'.
	/// </summary>
	[RegularExpression(@"^(localhost|[a-zA-Z0-9.-]+)$", ErrorMessage = "Value for {0} must be a valid host.")]
	public string Host { get; set; } = "localhost";

	/// <summary>
	/// Gets or sets the database server port. Defaults to 5432.
	/// </summary>
	[Range(1, 65535, ErrorMessage = "Value for {0} must be between {1} and {2}.")]
	public int Port { get; set; } = 5432;

	/// <summary>
	/// Gets or sets the name of the database. Defaults to 'postgres'.
	/// </summary>
