...
This document will guide you through the installation steps to start the Guideline Service in an organized manner.
...
- Execute the following command: `docker compose -p guideline-service -f docker-compose.yml -f docker‐compose-override.yml up -d`.

If you can access `localhost:5008/swagger` your GuidelineService Server is now ready for use. 

![The GuidelineService swagger website.](screenshots/installation-screenshot-001.png)
